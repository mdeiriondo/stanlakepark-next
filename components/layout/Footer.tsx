...
export default function Footer() {
  return (
    <footer className="bg-[#0a0a0a] text-white py-32 px-6 border-t border-white/5 font-sans">
      ...
      <div className="max-w-[1600px] mx-auto mt-24 pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between gap-8 text-[10px] text-gray-600 uppercase tracking-[0.4em]">
