...
export default function ExperienceCard({
  ...
  const imageUrl = image || 'https://images.unsplash.com/photo-1506377247377-2a5b3b417ebb?q=80&w=2670&auto=format&fit=crop';
  
  return (
    <TransitionLink href={`/experiences/${slug}`} className="group block h-full">
