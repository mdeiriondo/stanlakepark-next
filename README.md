...
Framework: Next.js 16.1.6 (App Router) using Turbopack for ultra-fast development cycles and improved HMR.
Styling Engine: Tailwind CSS 4.0 (CSS-first engine), providing a zero-runtime CSS footprint and simplified configuration.
...
Icons: Lucide React for a clean, consistent, and lightweight iconography.
✨ Key Design Features
